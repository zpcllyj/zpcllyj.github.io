...
I am a postdoctoral research associate at the [Climate Systems Engineering Initiative](https://climateengineering.uchicago.edu/), part of the [Institute for Climate and Sustainable Growth](https://climate.uchicago.edu/) at [the University of Chicago](https://www.uchicago.edu/), hosted by [Prof. Tiffany Shaw](https://geosci.uchicago.edu/~tas1/) and [Prof. Da Yang](https://www.yang-climate-group.org/). My research has focused on atmospheric responses to tropical ocean variability, particularly large-scale circulations such as the Hadley cell, superrotation, the ITCZ, and the Asian monsoon. Broadly, I am interested in uncovering the physical mechanisms that govern climate variability and shape its predictability.
